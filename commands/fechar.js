...
await sock.sendMessage(fromJid, { text: "🔒 *Grupo fechado!* Apenas administradores podem enviar mensagens." });
} catch (e) {
await sock.sendMessage(fromJid, { text: "❌ Erro ao fechar grupo." });
}}};
